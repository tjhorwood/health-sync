  ...
  return (
    <div className="bg-white py-10 md:py-14">
      <div className="mx-auto max-w-8xl px-6 text-center">
        ...
        <ul
          role="list"
          className="mx-auto mt-12 md:mt-20 grid max-w-2xl grid-cols-1 gap-x-4 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-4"
          data-aos='zoom-y-out'
        >
          {people.map((person) => (
            <li key={person.name}>
              <Image 
                ...
                width={224}
                height={224}
                className="mx-auto rounded-full md:scale-[1.2]" 
              />
