        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-600">
              We have transformed product development, making it faster, simpler... better! That&apos;swhy in just three years we now help more developers build projects than anyone else.
            </p>
          </div>
