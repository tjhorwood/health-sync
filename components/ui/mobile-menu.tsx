      ...
      <div ref={mobileNav}>
        ...
        >
          <div className='flex flex-col space-y-4'>
            <ul className='px-5 py-2 font-medium space-y-4'>
              {navItems.map((item: any, itemIdx: any) => (
                <li key={itemIdx}>
                  <Link
                    href={item.href}
                    className='flex text-gray-600 hover:text-teal-400 text-lg'
            ...
            <div className='px-5 py-2 w-full mx-auto flex flex-col items-center space-y-4'>
              ...
              <div className='flex grow justify-center flex-wrap items-center gap-4'>
                <Button
                  size='lg'
                  className='hover:scale-[1.15] transition duration-300 space-x-2'
                >
                ...
                <Button
                  size='lg'
                  className='hover:scale-[1.15] transition-all duration-300 space-x-2'
                >
